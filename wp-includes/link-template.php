 ...
 *       
 * @param string $mode
 *        	Permalink mode can be either 'title', 'id', or default, which is 'id'.
 */
 ...
 *        	Optional. Post ID or post object. Default is the current post.
 ...
 *       
 * @param int|WP_Post $id
 *        	Optional. Post ID or post object. Default current post.
 * @param bool $leavename
 *        	Optional. Whether to keep post name or page name. Default false.
 * @return string|bool The permalink URL or false if post does not exist.
 */
	...
	if ('' != $permalink && ! in_array ( $post->post_status, array (
		...
		if (strpos ( $permalink, '%category%' ) !== false) {
			...
			if ($cats) {
				 ...
				 * @param array $cats
				 *        	Array of all categories associated with the post.
				 * @param WP_Post $post
				 *        	The post in question.
				 */
 ...
 * @param bool $leavename
 *        	Optional, defaults to false. Whether to keep page name.
 * @param bool $sample
 *        	Optional, defaults to false. Is it a sample permalink.
 * @return string
 */
 ...
 * @param string $feed
 *        	Optional, defaults to default feed. Feed type.
 */
 ...
 *        	Descriptive text.
 * @param int $post_id
 *        	Optional post ID. Default to current post.
 * @param string $feed
 *        	Optional. Feed format.
 ...
 *        	Optional, defaults to display. How to write the '&', defaults to '&amp;'.
 * @return string
 */
 ...
 *        	Optional. Array or comma-separated list of excluded term IDs.
 * @param bool $start
 *        	Optional. Whether to retrieve first or last post.
 * @param string $taxonomy
 *        	Optional. Taxonomy, if $in_same_term is true. Default 'category'.
 ...
 *        	Optional. Whether link should be in a same taxonomy term.
 * @param array|string $excluded_terms
 *        	Optional. Array or comma-separated list of excluded terms IDs.
 * @param bool $previous
 *        	Optional. Whether to display link to previous or next post. Default true.
 * @param string $taxonomy
 *        	Optional. Taxonomy, if $in_same_term is true. Default 'category'.
 ...
 *        	Optional. Whether link should be in a same taxonomy term.
 * @param array|string $excluded_terms
 *        	Optional. Array or comma-separated list of excluded category IDs.
 * @param bool $previous
 *        	Optional. Whether to display link to previous or next post. Default true.
 * @param string $taxonomy
 *        	Optional. Taxonomy, if $in_same_term is true. Default 'category'.
 ...
 *        	Optional. Path relative to the site url.
 * @param string $scheme
 *        	Optional. Scheme to give the site url context. Currently 'http', 'https', 'login', 'login_post', 'admin', or 'relative'.
 * @return string Site url link with optional path appended.
 *        
 */
 ...
 * @param string $scheme
 *        	Optional. Scheme to give the includes url context.
 ...
 * @param string $path
 *        	Optional path relative to the dashboard. Use only paths known to both blog and user admins.
 * @param string $scheme
 *        	The scheme to use. Default is 'admin', which obeys force_ssl_admin() and is_ssl(). 'http' or 'https' can be passed to force those schemes.
 ...
 *       
 * @param int $id
 *        	A post or blog id. Default is 0, which means the current post or blog.
 * @param string $context
 *        	Whether the id is a 'blog' id, 'post' id, or 'media' id. If 'post', the post_type of the post is consulted. If 'query', the current query is consulted to determine the id and context. Default is 'post'.
