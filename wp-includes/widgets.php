...
class WP_Widget {
	 ...
	 *        	Optional Base ID for the widget, lower case,
 ...
 *      
 * @param string|array $args
 *        	Arguments for the sidebar being registered.
 ...
 * @param array|string $options
 *        	Optional. Widget options. See above long description.
 * @param mixed $params,...
 *        	Optional. Additional parameters to add to widget.
 */
 ...
 * @param int $widget_id
 *        	Optional, but needed for checking. Widget ID.
 * @param string $id_base
 ...
 *       
 * @param string $widget
 *        	the widget's PHP class name (see default-widgets.php)
 * @param array $instance
