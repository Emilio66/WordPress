 ...
 *        	Page to redirect to.
 * @param string $after
 *        	Optional, default is 'bottom'. Where to add rule, can also be 'top'.
 */
 ...
 * @param string $query
 *        	String to append to the rewritten query. Must end in '='. Optional.
 */
 ...
 *        	Permalink structure.
 * @param array $args
 *        	Optional configuration for building the rules from the permalink structure,
 ...
 *        	Name of the corresponding query variable. Defaults to $name.
 */
...
class WP_Rewrite {
	 ...
	 * categories, added by {@link add_permastruct()}.
	 *
	 * @since 2.1.0
	 * @access private
	 * @var array
	...
	/**
	 * Add or update existing rewrite tags (e.g.
	 * %postname%).
	 *
	 ...
	 * @param int $ep_mask
	 *        	Endpoint mask defining what endpoints are added to the structure. Default is EP_NONE.
	 * @param bool $paged
	 *        	Should archive pagination rules be added for the structure? Default is true.
	 * @param bool $feed
	 *        	Should feed rewrite rules be added for the structure? Default is true.
	 * @param bool $forcomments
	 *        	Should the feed rules be a query for a comments feed? Default is false.
	 * @param bool $walk_dirs
	 *        	Should the 'directories' making up the structure be walked over and rewrite rules
	 *        	built for each in turn? Default is true.
	 * @param bool $endpoints
	 *        	Should endpoints be applied to the generated rewrite rules? Default is true.
	...
	/**
	 * Retrieve mod_rewrite formatted rewrite rules to write to .
	 * htaccess.
	 *
	...
	public function mod_rewrite_rules() {
		...
		/**
		 * Filter the list of rewrite rules formatted for output to an .
		 * htaccess file.
		 *
		 * @since 1.5.0
	 ...
	 *        
	 * @param string $regex
	 *        	Regular expression to match against request.
	 * @param string $redirect
	 *        	URL regex redirects to when regex matches request.
	 * @param string $after
	 *        	Optional, default is bottom. Location to place rule.
	 */
	 ...
	 *        	Endpoint mask describing the places the endpoint should be added.
	 * @param string $query_var
	 *        	Name of the corresponding query variable. Default is value of $name.
	 */
