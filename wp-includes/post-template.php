...
function get_post_class($class = '', $post_id = null) {
	 ...
	 * @param string $class
	 *        	A comma-separated list of additional classes added to the post.
	 * @param int $post_id
	 *        	The post ID.
	 */
...
function get_body_class($class = '') {
	 ...
	 * @param string $class
	 *        	A comma-separated list of additional classes added to the body.
	 */
 ...
 * @param bool $permalink
 *        	Optional, default is false. Whether to add permalink to image.
 * @param bool $icon
 *        	Optional, default is false. Whether to include icon.
 * @param string|bool $text
 *        	Optional, default is false. If string, then will be link text.
 ...
 *        	The specific template name if specific matching is required.
 ...
 *       
 * @param int $post_id
 *        	Optional. The page ID to check. Defaults to the current post, when used in the loop.
