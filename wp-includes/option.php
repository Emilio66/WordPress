...
function get_option($option, $default = false) {
	...
	if (! defined ( 'WP_INSTALLING' )) {
		...
		if (isset ( $notoptions [$option] ))
			 ...
			 *       
			 * @param mixed $default
			 *        	The default value to return if the option
 ...
 * @param bool $autoload
 *        	Optional. Default is enabled. Whether to load the option when WordPress starts up.
 ...
 *        	Whether to use cache. Multisite only. Default true.
 * @return mixed Value set for the option.
 */
...
function update_site_option($option, $value) {
	 ...
	 *       
	 * @param mixed $value
	 *        	New value of site option.
	 * @param mixed $old_value
	 *        	Old value of site option.
	 */
