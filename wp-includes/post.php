 ...
 * @param string $output
 *        	Optional. Constant for return type. Accepts OBJECT, ARRAY_A, ARRAY_N.
 *        	Default OBJECt.
 ...
 * @param string $output
 *        	Optional, default is Object. Accepts OBJECT, ARRAY_A, or ARRAY_N.
 *        	Default OBJECT.
 * @param string $filter
 ...
 *
 * @param array|string $args
 *        	Optional. Array or string of post status arguments. Default array.
 * @param string $output
 *        	Optional. The type of output to return. Accepts post status 'names'
 ...
 *        	or 'objects'. Default 'names'.
 * @param string $operator
 *        	Optaionl. The logical operation to perform. 'or' means only one
...
function register_post_type($post_type, $args = array()) {
	...
	if (! empty ( $args->supports )) {
		...
		add_post_type_support ( $post_type, array (
				'title',
				'editor' 
		) );
	}
...
function get_post_type_labels($post_type_object) {
	 ...
	 *     
	 * @param array $labels
	 *        	Array of labels for the given post type.
	 */
 ...
 *        	Post ID.
 * @param string $context
 *        	How to sanitize post fields. Looks for 'raw', 'edit',
 ...
 * @param array $args
 *        	Optional. Category arguments. Default empty.
 ...
 * @param array $args
 *        	Optional. {@link wp_get_object_terms()} arguments. Default empty array.
 * @return array List of post tags.
 */
 ...
 * @param string $output
 *        	Optional. Type of output. Accepts ARRAY_A or ''. Default ARRAY_A.
 ...
 *        	Default 0.
 * @param string $tags
 *        	Optional. The tags to set for the post, separated by commas. Default empty.
 ...
 *        	Optional. The Post ID. Does not default to the ID of the global $post.
 * @param string $tags
 *        	Optional. The tags to set for the post, separated by commas.
 *        	Default empty.
 * @param bool $append
 ...
 * @param string $output
 *        	Optional. What to output. Accepts OBJECT, ARRAY_A, or ARRAY_N.
 *        	Default OBJECT.
 * @param string $filter
 ...
 *        	Page path.
 * @param string $output
 *        	Optional. Output type. Accepts OBJECT, ARRAY_N, or ARRAY_A.
 *        	Default OBJECT.
 ...
 * @param
 *        	array &$result Result, passed by reference.
 */
 ...
 *       
 * @param string $post_type
 *        	Post type. Currently only supports 'post' or 'page'.
 ...
 *        	The location to get the time. Accepts 'gmt', 'blog',
...
function get_lastpostdate($timezone = 'server') {
	 ...
	 *       
	 * @param string $date
	 *        	Date the last post was published. Likely values are 'gmt',
	 *        	'blog', or 'server'.
	 * @param string $timezone
 ...
 *       
 * @param string $timezone
 *        	The location to get the time. Accepts 'gmt', 'blog', or 'server'.
 *        	Default 'server'.
 ...
 *        	The location to get the time. Accepts 'gmt', 'blog', or 'server'.
 * @param string $field
 *        	Field to check. Can be 'date' or 'modified'.
