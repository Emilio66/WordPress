...
final class WP_Customize_Widgets {
	 ...
	 * @access public
	 *        
	 * @param array|bool|mixed $value
	 *        	Widget instance(s), false if open was empty.
	...
	public function customize_register() {
		...
		), array_fill_keys ( array_keys ( $GLOBALS ['wp_registered_sidebars'] ), array () ), wp_get_sidebars_widgets () );
		...
		foreach ( array_keys ( $wp_registered_widgets ) as $widget_id ) {
			...
			$setting_args ['sanitize_callback'] = array (
					$this,
					'sanitize_widget_instance' 
			);
			$setting_args ['sanitize_js_callback'] = array (
					$this,
	...
	public function enqueue_scripts() {
		...
		$wp_scripts->add_data ( 'customize-widgets', 'data', sprintf ( 'var _wpCustomizeWidgetsSettings = %s;', json_encode ( $settings ) ) );
	}
