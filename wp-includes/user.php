 ...
 *        	Optional. Post type to check. Defaults to post.
...
class WP_User_Query {
	...
	public function prepare_query($query = array()) {
		...
		if (isset ( $qv ['orderby'] )) {
			...
			} elseif (in_array ( $qv ['orderby'], array (
					'user_nicename',
					'user_email',
					'user_url',
					'user_registered' 
	 ...
	 * @param array $cols        	
	 * @param bool $wild
	 *        	Whether to allow wildcard searches. Default is false for Network Admin, true for
 ...
 *        	User ID
 * @param bool $all
 *        	Whether to retrieve all blogs, or only blogs that are not
...
function get_blogs_of_user($user_id, $all = false) {
	 ...
	 *       
	 * @param array $blogs
	 *        	An array of blog objects belonging to the user.
	 * @param int $user_id
	 *        	User ID.
	 * @param bool $all
	 *        	Whether the returned blogs array should contain all blogs, including
