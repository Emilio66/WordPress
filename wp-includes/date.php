...
class WP_Date_Query {
	 ...
	 * Can be either 'AND' or 'OR' and can be changed via the query arguments.
	 *
	 * @since 3.7.0
	 * @access public
	 * @var string
	...
	public function validate_column($column) {
		 ...
		 *        	An array of valid date query columns. Defaults are 'post_date', 'post_date_gmt',
		 *        	'post_modified', 'post_modified_gmt', 'comment_date', 'comment_date_gmt'
		 */
	 ...
	 * @param string $default_to
	 *        	Controls what values default to if they are missing from $datetime. Pass "min" or "max".
