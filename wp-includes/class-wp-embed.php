...
<?php
	 ...
	 * Do not use this function directly, use {@link wp_embed_register_handler()} instead.
	 ...
	 * Do not use this function directly, use {@link wp_embed_unregister_handler()} instead.
	 *
	 * @param string $id
	...
	public function shortcode($attr, $url = '') {
		...
		if ($post_ID) {
			 ...
			 *
			 * @param bool $enable
			 *        	Whether to enable <link> tag discovery. Default false.
			 */
	...
	public function autoembed($content) {
		return preg_replace_callback ( '|^\s*(https?://[^\s"]+)\s*$|im', array (
				$this,
				'autoembed_callback' 
		), $content );
	}
