...
function wptexturize($text, $reset = false) {
	...
	if ($reset || ! isset ( $static_characters )) {
		...
		$default_no_texturize_tags = array (
				'pre',
				'code',
				'kbd',
				'style',
		...
		$default_no_texturize_shortcodes = array (
				'code' 
		);
	 ...
	 * @since 2.8.0
	 *       
	 * @param array $default_no_texturize_tags
	 ...
	 * @since 2.8.0
	 *       
	 * @param array $default_no_texturize_shortcodes
 ...
 * Push element to stack on tag open and pop
 * on tag close.
 *
 ...
 *        	Optional. The value to return if the sanitization ends up as an empty string.
 ...
 * @param bool $richedit
 *        	Whether the $content should not pass through htmlspecialchars(). Default false (meaning it will be passed).
 ...
 *        	Date and time in ISO 8601 format {@link http://en.wikipedia.org/wiki/ISO_8601}.
 * @param string $timezone
 ...
 * @param string $more
 *        	Optional. What to append if $text needs to be trimmed. Default '&hellip;'.
...
function wp_trim_words($text, $num_words = 55, $more = null) {
	 ...
	 * @param string $more
	 *        	An optional string to append to the end of the trimmed text, e.g. &hellip;.
...
function wp_basename($path, $suffix = '') {
	return urldecode ( basename ( str_replace ( array (
			'%2F',
			'%5C' 
