...
function get_footer($name = null) {
	 ...
	 *       
	 * @param string $name
	 *        	Name of the specific footer file to use.
	 */
...
function get_sidebar($name = null) {
	 ...
	 *       
	 * @param string $name
	 *        	Name of the specific sidebar file to use.
	 */
 ...
 * By default, it echoes
 * the HTML immediately. Pass array('echo'=>false) to return the string instead.
 *
 * @since 3.0.0
 *       
 * @param array $args
 *        	Configuration options to modify the form output.
 * @return string|null String when retrieving, null when displaying.
 */
 ...
 *       
 * @param string $before
 *        	Text to output before the link (defaults to <li>).
 * @param string $after
 *        	Text to output after the link (defaults to </li>).
 * @param boolean $echo
 *        	Default to echo and not return the link.
 * @return string|null String when retrieving, null when displaying.
 */
 ...
 *       
 * @param string $sep
 *        	Optional, default is '&raquo;'. How to separate the various items within the page title.
 * @param bool $display
...
function user_can_richedit() {
	 ...
	 *        	Whether the user can access to the rich (Visual) editor.
	 */
 ...
 * @param string $url
 *        	The url of the css file containing the colour scheme.
 * @param array $colors
 *        	Optional An array of CSS color definitions which are used to give the user a feel for the theme.
 * @param array $icons
 *        	Optional An array of CSS color definitions used to color any SVG icons
 */
