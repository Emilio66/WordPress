...
<div id="wp-fullscreen-body"
	class="wp-core-ui<?php if ( is_rtl() ) echo ' rtl'; ?>"
	data-theme-width="<?php echo (int) $width; ?>"
	data-dfw-width="<?php echo (int) $dfw_width; ?>">
	<div id="fullscreen-topbar">
		<div id="wp-fullscreen-toolbar">
			<div id="wp-fullscreen-close">
				<a href="#" onclick="wp.editor.fullscreen.off();return false;"><?php _e('Exit fullscreen'); ?></a>
			</div>
		...
		$buttons = array (
				...
				'wp-media-library' => array (
						'title' => __ ( 'Media library (Alt + Shift + M)' ),
						'both' => true 
				),
				'link' => array (
		 ...
		 *       
		 * @param array $buttons
		 *        	An array of TinyMCE buttons for the DFW editor.
		 */
		...
		?>
				...
				<div id="wp-fullscreen-save">
					<input type="button" class="button button-primary right"
						value="<?php echo $save; ?>"
						onclick="wp.editor.fullscreen.save();" /> <span
...
<div class="fullscreen-overlay fullscreen-fader fade-300"
...
<div id="wp-link-wrap"
	class="wp-core-ui<?php echo $search_panel_visible; ?>"
	style="display: none">
			...
			<div id="link-options">
				...
				<div class="link-target">
					<label><span>&nbsp;</span><input type="checkbox"
						id="link-target-checkbox" /> <?php _e( 'Open link in a new window/tab' ); ?></label>
				</div>
			</div>
			<p class="howto">
				<a href="#" id="wp-link-search-toggle"><?php _e( 'Or link to existing content' ); ?></a>
			</p>
			<div id="search-panel">
