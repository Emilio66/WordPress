 ...
 * @param
 *        	context Could be 'display' (like in a theme) or 'edit' (like inserting into an editor)
...
function image_downsize($id, $size = 'medium') {
	 ...
	 *        	Attachment ID for image.
	 * @param array|string $size
	 *        	Size of image, either array or string. Default 'medium'.
	 */
 ...
 *        	Optional. Whether to crop images to specified height and width or resize.
 ...
 * @param bool|array $crop
 *        	Optional. Whether to crop image to specified height and width or resize.
 *        	An array can specify positioning of the crop area. Default false.
...
function image_resize_dimensions($orig_w, $orig_h, $dest_w, $dest_h, $crop = false) {
	 ...
	 *        	New height in pixels.
	 * @param bool|array $crop
	 *        	Whether to crop image to specified height and width or resize.
	 *        	An array can specify positioning of the crop area. Default false.
	 */
...
function gallery_shortcode($attr) {
	 ...
	 *        	Default gallery shortcode CSS styles.
	 * @param string $gallery_div
	 *        	Opening HTML div container for the gallery shortcode output.
	 */
 ...
 *       
 * @param bool $prev
 *        	Optional. Default is true to display previous link, false for next.
 */
 ...
 *      
 * @param string $output
 *        	The type of output to return, either taxonomy 'names' or 'objects'. 'names' is the default.
 ...
 * This function should probably only be used for sites that do not support oEmbed.
 *
 * @since 2.9.0
 ...
 * @param array $args
 *        	Additional data. Accepts { 'mime_type'=>string, 'methods'=>{string, string, ...} }
 ...
 *        	Array of requirements. Accepts { 'mime_type'=>string, 'methods'=>{string, string, ...} }
 ...
 * @param array $types
 *        	array of media types: 'audio', 'video', 'object', 'embed', or 'iframe'
