...
<p>
	...
	<br /> <input class="checkbox" type="checkbox" <?php echo $count; ?>
...
function wp_widget_rss_form($args, $inputs = null) {
	...
	if ($inputs ['url']) :
		?>
<p>
	<label for="rss-url-<?php echo $args['number']; ?>"><?php _e( 'Enter the RSS feed URL here:' ); ?></label>
	<input class="widefat" id="rss-url-<?php echo $args['number']; ?>"
		name="widget-rss[<?php echo $args['number']; ?>][url]" type="text"
		value="<?php echo $args['url']; ?>" />
</p>
<?php endif; if ( $inputs['title'] ) : ?>
<p>
	<label for="rss-title-<?php echo $args['number']; ?>"><?php _e( 'Give the feed a title (optional):' ); ?></label>
...
<p>
	<label for="rss-items-<?php echo $args['number']; ?>"><?php _e( 'How many items would you like to display?' ); ?></label>
...
<p>
	<input id="rss-show-summary-<?php echo $args['number']; ?>"
		name="widget-rss[<?php echo $args['number']; ?>][show_summary]"
...
<p>
	<input id="rss-show-author-<?php echo $args['number']; ?>"
		name="widget-rss[<?php echo $args['number']; ?>][show_author]"
		type="checkbox" value="1" <?php checked( $args['show_author'] ); ?> />
	<label for="rss-show-author-<?php echo $args['number']; ?>"><?php _e( 'Display item author if available?' ); ?></label>
</p>
<?php endif; if ( $inputs['show_date'] ) : ?>
<p>
	<input id="rss-show-date-<?php echo $args['number']; ?>"
		name="widget-rss[<?php echo $args['number']; ?>][show_date]"
		type="checkbox" value="1" <?php checked( $args['show_date'] ); ?> /> <label
		for="rss-show-date-<?php echo $args['number']; ?>"><?php _e( 'Display item date?' ); ?></label>
</p>
	...
	foreach ( array_keys ( $default_inputs ) as $input ) :
		if ('hidden' === $inputs [$input]) :
			...
			?>
<input type="hidden"
	id="rss-<?php echo $id; ?>-<?php echo $args['number']; ?>"
...
class WP_Widget_Tag_Cloud extends WP_Widget {
	...
	public function widget($args, $instance) {
		 ...
		 * @see wp_tag_cloud()
		 *
		 * @param array $current_taxonomy
		 *        	The taxonomy to use in the tag cloud. Default 'tags'.
		 */
...
foreach ( get_taxonomies () as $taxonomy ) :
		...
		<option value="<?php echo esc_attr($taxonomy) ?>"
			<?php selected($taxonomy, $current_taxonomy) ?>><?php echo $tax->labels->name; ?></option>
	<?php endforeach; ?>
	</select>
</p><?php
	}
