 ...
 *       
 * @param string $type
 *        	Type of time to retrieve. Accepts 'mysql', 'timestamp', or PHP date
 ...
 * @param bool|int $unixtimestamp
 *        	Optional. Unix timestamp. Default false.
 * @param bool $gmt
 *        	Optional. Whether to use GMT timezone. Default false.
 *        	
...
function date_i18n($dateformatstring, $unixtimestamp = false, $gmt = false) {
	 ...
	 *        	Unix timestamp.
	 * @param bool $gmt
	 *        	Whether to convert to GMT for time. Default false.
	 */
 ...
 * @param int $decimals
 *        	Optional. Precision of number of decimal places. Default 0.
 ...
 * @param bool $query
 *        	Optional. When false uses the $_SERVER value. Default false.
 * @return string New URL query string.
 */
 ...
 *       
 * @param bool $echo
 *        	Optional. Whether to echo the original http referer. Default true.
 * @param string $jump_back_to
 *        	Optional. Can be 'previous' or page you want to jump back to.
 *        	Default 'current'.
...
function wp_upload_bits($name, $deprecated, $bits, $time = null) {
	 ...
	 * @since 3.0.0
	 *       
	 * @param mixed $upload_bits_error
	 *        	An array of upload bits data, or a non-array error to return.
	 */
	$upload_bits_error = apply_filters ( 'wp_upload_bits', array (
			'name' => $name,
			'bits' => $bits,
			'time' => $time 
	) );
...
function wp_ext2type($ext) {
	 ...
	 *        	Multi-dimensional array with extensions for a default set
	 *        	of file types.
	 */
 ...
 * @param string $filename
 *        	The name of the file (may differ from $file due to $file being
 *        	in a tmp directory).
 * @param array $mimes
 *        	Optional. Key is the file extension with value as the mime type.
...
function wp_check_filetype_and_ext($file, $filename, $mimes = null) {
	 ...
	 *        	File data array containing 'ext', 'type', and
	 *        	'proper_filename' keys.
	 * @param string $file
	 *        	Full path to the file.
	 * @param string $filename
	 *        	The name of the file (may differ from $file due to
...
function wp_get_mime_types() {
	 ...
	 *        	Mime types keyed by the file extension regex
 ...
 *        	Optional. User to check. Defaults to current user.
...
function get_allowed_mime_types($user = null) {
	 ...
	 *       
	 * @param array $t
	 *        	Mime types keyed by the file extension regex corresponding to
 ...
 *        	Optional. Error message. Default empty.
 * @param string $title
...
function wp_maybe_load_widgets() {
	 ...
	 * @since 2.8.0
	 *       
	 * @param bool $wp_maybe_load_widgets
 ...
 * @param string $replacement
 *        	Optional. The file that should have been included based on ABSPATH.
 *        	Default null.
 * @param string $message
...
function iis7_supports_permalinks() {
	 ...
	 * @since 2.8.0
	 *       
	 * @param bool $supports_permalinks
 ...
 *       
 * @param bool $suspend
 *        	Optional. Whether to suspend or enable cache invalidation. Default true.
 * @return bool The current suspend setting.
 */
 ...
 *        	Optional. Network ID to test. Defaults to current network.
 ...
 *        	Optional. Additional arguments to send to $callback.
 * @return array IDs of all members of loop.
 */
function wp_find_hierarchy_loop($callback, $start, $start_parent, $callback_args = array()) {
	$override = is_null ( $start_parent ) ? array () : array (
			$start => $start_parent 
	);
 ...
 *        	Optional. An array of ( ID => parent_ID, ... ) to use instead of $callback.
 *        	Default empty array.
 * @param array $callback_args
 *        	Optional. Additional arguments to send to $callback. Default empty array.
 * @param bool $_return_loop
 *        	Optional. Return loop members or just detect presence of loop? Only set
...
function wp_find_hierarchy_loop_tortoise_hare($callback, $start, $override = array(), $callback_args = array(), $_return_loop = false) {
	...
	while ( $tortoise && ($evanescent_hare = isset ( $override [$hare] ) ? $override [$hare] : call_user_func_array ( $callback, array_merge ( array (
			$hare 
	), $callback_args ) )) && ($hare = isset ( $override [$evanescent_hare] ) ? $override [$evanescent_hare] : call_user_func_array ( $callback, array_merge ( array (
			$evanescent_hare 
	), $callback_args ) )) ) {
		if ($_return_loop)
		...
		$tortoise = isset ( $override [$tortoise] ) ? $override [$tortoise] : call_user_func_array ( $callback, array_merge ( array (
				$tortoise 
		), $callback_args ) );
	}
...
<div id="wp-auth-check-wrap" class="<?php echo $wrap_class; ?>">
	...
	<div class="wp-auth-fallback">
			<p>
				<b class="wp-auth-fallback-expired" tabindex="0"><?php _e('Session expired'); ?></b>
			</p>
			<p>
