...
if (! function_exists ( 'check_admin_referer' )) :
	 ...
	 *        	where to look for nonce in $_REQUEST (since 2.5)
	 */
	function check_admin_referer($action = -1, $query_arg = '_wpnonce') {
		 ...
		 *        	The nonce action.
		 * @param bool $result
		 *        	Whether the admin request nonce was validated.
		 */
...
if (! function_exists ( 'check_ajax_referer' )) :
	...
	function check_ajax_referer($action = -1, $query_arg = false, $die = true) {
		 ...
		 * @param bool $result
		 *        	Whether the AJAX request nonce was validated.
		 */
...
if (! function_exists ( 'wp_new_user_notification' )) :
	 ...
	 *        	Optional. The user's plaintext password. Default empty.
	 */
...
if (! function_exists ( 'wp_generate_password' )) :
	 ...
	 *        	Whether to include other special characters. Used when
...
if (! function_exists ( 'get_avatar' )) :
	 ...
	 * @param string $alt
	 *        	Alternative text to use in image tag. Defaults to blank
	...
	function get_avatar($id_or_email, $size = '96', $default = '', $alt = false) {
		...
		if (is_ssl ()) {
			...
			if (! empty ( $email ))
				...
				$host = 'http://www.gravatar.com'; // change 0.gravatar.com to this one
		}
		 ...
		 *       
		 * @param string $avatar
		 *        	Image tag for the user's avatar.
		 * @param int|object|string $id_or_email
		 *        	A user ID, email address, or comment object.
		 * @param int $size
