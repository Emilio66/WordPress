 ...
 *        	Metadata key
 * @param mixed $meta_value
 *        	Optional. Metadata value. Must be serializable if non-scalar. If specified, only delete metadata entries
...
class WP_Meta_Query {
	 ...
	 * A single query is an associative array:
