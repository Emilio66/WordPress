 ...
 *        	A blog ID, a blog slug, or an array of fields to query against. Optional. If not specified the current blog ID is used.
 * @param bool $get_all
 ...
 *       
 * @param stdClass $blog
 *        	The blog details as returned from get_blog_details()
 */
