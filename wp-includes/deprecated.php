 ...
 *        	Textarea content.
 * @param string $id
 *        	Optional, default is 'content'. HTML ID attribute value.
 * @param string $prev_id
 *        	Optional, not used
 * @param bool $media_buttons
 *        	Optional, default is true. Whether to display media buttons.
 * @param int $tab_index
 *        	Optional, not used
 */
 ...
 *
 * @param callback $wp_head_callback
 *        	Call on 'wp_head' action.
 * @param callback $admin_head_callback
 *        	Call on custom header administration screen.
 * @param callback $admin_preview_callback
