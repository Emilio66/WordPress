 ...
 *        	The logical operation to perform. 'or' means only one element
...
/**
 * Create or modify a taxonomy object.
 ...
 *        	See optional args description above.
...
class WP_Tax_Query {
	 ...
	 * A single taxonomy query is an associative array:
...
function get_terms($taxonomies, $args = '') {
	 ...
	 * @param string|array $taxonomies
	 *        	A taxonomy or array of taxonomies.
	 */
	...
	if (false !== $cache) {
		 ...
		 *       
		 * @param array $cache
		 *        	Cached array of terms for the given taxonomy.
		 * @param string|array $taxonomies
		 *        	A taxonomy or array of taxonomies.
		 * @param array $args
		 *        	An array of arguments to get terms.
		 */
 ...
 *        	Taxonomy name
 * @param array|string $args
 *        	Overwrite defaults. See get_terms()
...
function wp_delete_term($term, $taxonomy, $args = array()) {
	...
	foreach ( ( array ) $objects as $object ) {
		$terms = wp_get_object_terms ( $object, $taxonomy, array (
				'fields' => 'ids',
				'orderby' => 'none' 
		) );
...
function wp_get_object_terms($object_ids, $taxonomies, $args = array()) {
	 ...
	 *        	A taxonomy or array of taxonomies.
	 * @param array $args
	 *        	An array of arguments for retrieving terms for
	 *        	the given object(s).
	 */
 ...
 *        	Whether to clean taxonomy wide caches (true), or just individual term object caches (false). Default is true.
 */
