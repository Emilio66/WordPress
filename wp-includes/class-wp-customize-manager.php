...
final class WP_Customize_Manager {
	...
	public function __construct() {
		...
		add_action ( 'wp_redirect_status', array (
				$this,
				'wp_redirect_status' 
		), 1000 );
