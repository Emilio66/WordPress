...
class Walker_Category extends Walker {
	 ...
	 * @param array $args
	 *        	An array of arguments. Will only append content if style argument value is 'list'.
...
class Walker_CategoryDropdown extends Walker {
	 ...
	 * @param array $args
	 *        	Uses 'selected' and 'show_count' keys, if they exist. @see wp_dropdown_categories()
	 */
	public function start_el(&$output, $category, $depth = 0, $args = array(), $id = 0) {
