...
class WP_User {
	 ...
	 *        	User DB row object
	 * @param int $blog_id
	 *        	Optional. The blog id to initialize for
	 */
	 ...
	 *       
	 * @param string $field
	 *        	The field to query against: 'id', 'slug', 'email' or 'login'
	...
	public function has_cap($cap) {
		 ...
		 *       
		 * @param array $allcaps
		 *        	An array of all the role's capabilities.
		 * @param array $caps
