...
function wp_update_plugins($extra_stats = array()) {
	 ...
	 *       
	 * @param array $locales
	 *        	Plugin locale. Default is current locale of the site.
	 */
...
function wp_update_themes($extra_stats = array()) {
	 ...
	 *       
	 * @param array $locales
	 *        	Theme locale. Default is current locale of the site.
	 */
...
function _maybe_update_core() {
	...
	if (isset ( $current->last_checked ) && 12 * HOUR_IN_SECONDS > (time () - $current->last_checked) && isset ( $current->version_checked ) && $current->version_checked == $wp_version)
		return;
