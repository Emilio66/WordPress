...
class WP_Customize_Image_Control extends WP_Customize_Upload_Control {
	...
	public function __construct($manager, $id, $args) {
		...
		$this->add_tab ( 'upload-new', __ ( 'Upload New' ), array (
				$this,
				'tab_upload_new' 
		) );
		$this->add_tab ( 'uploaded', __ ( 'Uploaded' ), array (
				$this,
				'tab_uploaded' 
		) );
...
class WP_Customize_Background_Image_Control extends WP_Customize_Image_Control {
	...
	public function __construct($manager) {
		...
		if ($this->setting->default)
			$this->add_tab ( 'default', __ ( 'Default' ), array (
					$this,
...
<span class="reorder-toggle" tabindex="0"> <span class="reorder"><?php _ex( 'Reorder', 'Reorder widgets in Customizer' ); ?></span>
