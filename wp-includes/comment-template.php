 ...
 *        	Optional. The ID of the comment for which to retrieve the author. Default current comment.
 ...
 *       
 * @param int $comment_ID
 *        	Optional. The ID of the comment for which to print the author. Default current comment.
 */
 ...
 *       
 * @param int $comment_ID
 *        	Optional. The ID of the comment for which to get the author's email. Default current comment.
 ...
 *       
 * @param int $comment_ID
 *        	Optional. The ID of the comment for which to print the author's email. Default current comment.
 */
 ...
 *       
 * @param int $comment_ID
 *        	ID of the comment for which to get the author's link.
 ...
 *     
 * @param int $comment_ID
 *        	ID of the comment for which to print the author's
 ...
 *       
 * @param int $comment_ID
 *        	ID of the comment for which to get the author's IP
 ...
 *       
 * @param int $comment_ID
 *        	ID of the comment for which to print the author's IP
 *        	address. Default current comment.
 */
 ...
 *       
 * @param int $comment_ID
 *        	ID of the comment for which to get the author's URL.
 *        	Default current comment.
 * @return string
 */
 ...
 *       
 * @param int $comment_ID
 *        	ID of the comment for which to print the author's URL.
 *        	Default current comment.
 */
 ...
 *        	Default empty.
 * @param int $comment_id
 *        	Comment ID. Default current comment.
 ...
 * @param int $comment_ID
 *        	ID of the comment for which to get the date. Default current comment.
 ...
 * @param int $comment_ID
 *        	ID of the comment for which to print the date. Default current comment.
 */
 ...
 *       
 * @param int $comment_ID
 *        	ID of the comment for which to get the excerpt.
 *        	Default current comment.
 ...
 *       
 * @param int $comment_ID
 *        	ID of the comment for which to print the excerpt.
 *        	Default current comment.
 */
 ...
 * @param array $args
 *        	Optional. An array of arguments to override the defaults.
 ...
 *
 * @param int $comment_ID
 *        	ID of the comment for which to get the text. Default current comment.
 * @param array $args
 ...
 *
 * @param int $comment_ID
 *        	ID of the comment for which to print the text. Default 0.
 * @param array $args
 ...
 *       
 * @param int $comment_ID
 *        	ID of the comment for which to get the type. Default current comment.
 ...
 *       
 * @param int $width
 *        	Optional. The width of the popup window. Default 400.
 * @param int $height
 *        	Optional. The height of the popup window. Default 400.
 * @param string $file
...
function comments_popup_link($zero = false, $one = false, $more = false, $css_class = '', $none = false) {
	 ...
	 *        	The comments popup link attributes. Default empty.
	 */
...
class Walker_Comment extends Walker {
	 ...
	 *        	Comment data object.
	 * @param int $depth
	 *        	Depth of comment in reference to parents.
	 * @param array $args
	 *        	An array of arguments.
	 */
	 ...
	 *        	Passed by reference. Used to append additional content.
	 * @param object $comment
	 *        	The comment object. Default current comment.
	 * @param int $depth
	 *        	Depth of comment.
	 * @param array $args
	 *        	An array of arguments.
 ...
 *        	}
 * @param array $comments
 *        	Optional. Array of comment objects.
 */
	...
	<h3 id="reply-title" class="comment-reply-title"><?php comment_form_title( $args['title_reply'], $args['title_reply_to'] ); ?> <small><?php cancel_comment_reply_link( $args['cancel_reply_link'] ); ?></small>
		...
		class="comment-form" <?php echo $html5 ? ' novalidate' : ''; ?>>
			...
			<input name="<?php echo esc_attr( $args['name_submit'] ); ?>"
				type="submit" id="<?php echo esc_attr( $args['id_submit'] ); ?>"
