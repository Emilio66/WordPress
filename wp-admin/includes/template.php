 ...
 *       
 * @param int $post_id
 *        	Mark categories associated with this post as checked. $selected_cats must not be an array.
 * @param int $descendants_and_self
 *        	ID of the category to output along with its descendents.
 * @param bool|array $selected_cats
 *        	List of categories to mark as checked.
 * @param bool|array $popular_cats
 *        	Override the list of categories that receive the "popular-category" class.
 * @param object $walker
...
<?php endif; ?>
	<div id="replyhead" style="display: none;">
								<h5><?php _e( 'Reply to Comment' ); ?></h5>
							</div>
							<div id="addhead" style="display: none;">
								<h5><?php _e('Add new Comment'); ?></h5>
							</div>
 ...
 *        	Optional. The screen on which to show the box (like a post
 ...
 *        	String for use in the 'id' attribute of tags.
 * @param string|object $screen
 *        	The screen on which to show the box (post, page, link).
 * @param string $context
 *        	The context within the page where the boxes should show ('normal', 'advanced').
 */
 ...
 * @param string $type
 *        	The type of message it is, controls HTML class. Use 'error' or 'updated'.
 */
 ...
 * @param bool $limit_styles
 *        	Limit styles to colour-related styles only (unless others are enqueued).
 *        	
 */
...
function _post_states($post) {
	 ...
	 *        	An array of post display states. Values include 'Password protected',
 ...
 *        	The text of the button (defaults to 'Save Changes')
 * @param string $type
 *        	The type of button. One of: primary, secondary, delete
 * @param string $name
 *        	The HTML name of the submit button. Defaults to "submit". If no id attribute
 *        	is given in $other_attributes below, $name will be used as the button's id.
 * @param bool $wrap
 *        	True if the output button should be wrapped in a paragraph tag,
 *        	false otherwise. Defaults to true
 * @param array|string $other_attributes
 *        	Other attributes that should be output with the button,
