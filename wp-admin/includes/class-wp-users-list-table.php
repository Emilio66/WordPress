...
<div class="alignleft actions">
	 ...
	 * @param string $style
	 *        	Optional. Style attributes added to the <tr> element.
	 *        	Must be sanitized. Default empty.
	 * @param string $role
	 *        	Optional. Key for the $wp_roles array. Default empty.
	 * @param int $numposts
	...
	public function single_row($user_object, $style = '', $role = '', $numposts = 0) {
		...
		if (current_user_can ( 'list_users' )) {
			...
			$checkbox = '<label class="screen-reader-text" for="cb-select-' . $user_object->ID . '">' . sprintf ( __ ( 'Select %s' ), $user_object->user_login ) . '</label>' . "<input type='checkbox' name='users[]' id='user_{$user_object->ID}' class='$role' value='{$user_object->ID}' />";
		} else {
