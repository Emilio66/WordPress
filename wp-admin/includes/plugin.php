 ...
 * @param bool $markup
 *        	Optional. If the returned data should have HTML markup applied. Defaults to true.
 * @param bool $translate
 *        	Optional. If the returned data should be translated. Defaults to true.
...
function _get_plugin_data_markup_translate($plugin_file, $plugin_data, $markup = true, $translate = true) {
	...
	if ($translate) {
		...
		} elseif (in_array ( basename ( $plugin_file ), array (
				'hello.php',
				'akismet.php' 
		) )) {
			$textdomain = 'default';
 ...
 *        	Whether to enable the plugin for all sites in the
 *        	network or just the current site. Multisite only. Default is false.
 * @param bool $silent
 *        	Prevent calling activation hooks. Optional, default is false.
