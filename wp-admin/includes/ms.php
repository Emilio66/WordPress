 ...
 *        	Blog ID
 * @param bool $drop
 *        	True if blog's table should be dropped. Default is false.
 * @return void
 */
function wpmu_delete_blog($blog_id, $drop = false) {
	...
	if ($drop) {
		 ...
		 *       
		 * @param array $tables
		 *        	The blog tables to be dropped.
		 * @param int $blog_id
		 *        	The ID of the blog to drop tables for.
		 */
...
/**
 * Displays the amount of disk space used by the current blog.
 * Not used in core.
 *
 * @since MU
 */
...
<tr>
	...
	<td><input type="number" step="1" min="0" style="width: 100px"
		name="option[blog_upload_space]" value="<?php echo $quota; ?>" /> <?php _e( 'MB (Leave blank for network default)' ); ?></td>
</tr>
<?php
}
