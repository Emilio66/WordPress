 ...
 *        	id slug of the sidebar
 * @param
 *        	string optional $sidebar_name Include the HTML for the sidebar name
 */
...
<div class="sidebar-name">
	...
	<h3><?php echo esc_html( $sidebar_name ); ?> <span class="spinner"></span>
	</h3>
</div>
<?php
	}
...
<div class="widget-top">
	...
	<div class="widget-title">
		<h4><?php echo $widget_title ?><span class="in-widget-title"></span>
		</h4>
	</div>
</div>
