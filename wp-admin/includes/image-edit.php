	...
	<div id="imgedit-panel-<?php echo $post_id; ?>">
		...
		<div class="imgedit-submit">
						<span class="nowrap"><input type="text"
							...
							id="imgedit-scale-warn-<?php echo $post_id; ?>">!</span></span> <input
							type="button"
...
<?php if ( $can_restore ) { ?>
	...
	<div class="imgedit-group">
				<div class="imgedit-group-top">
					<h3>
						<a onclick="imageEdit.toggleHelp(this);return false;" href="#"><?php _e('Restore Original Image'); ?> <span
							class="dashicons dashicons-arrow-down imgedit-help-toggle"></span></a>
					</h3>
					<div class="imgedit-help">
						<p><?php
...
<?php } ?>
	...
	<div class="imgedit-group">
		...
		<span class="nowrap"> <input type="text"
						...
						style="width: 4em;" /> &times; <input type="text"
	...
	<div class="imgedit-group imgedit-applyto">
				...
				<p>
					<img src="<?php echo $thumb['url']; ?>"
						...
						alt="" draggable="false" /> <br /><?php _e('Current thumbnail'); ?>
	</p>
	...
	<?php } ?>
		...
		<div class="imgedit-menu">
				<div
					...
					title="<?php esc_attr_e( 'Crop' ); ?>"></div><?php
