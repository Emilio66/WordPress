...
<input name="photo_description[' + length + ']" value="' + desc +'"
	type="hidden" />
'); insert_editor( "\n\n" + encodeURI('
<p style="text-align: center;">
	<a href="<?php echo $url; ?>"><img src="' + img +'" alt="' + desc + '" /></a>
</p>
...
<div class="postbox">
	<h2><?php _e( 'Add Photos' ); ?> <small id="photo_directions">(<?php _e("click images to select") ?>)</small>
	</h2>
	<ul class="actions">
...
<body
		...
		<form action="press-this.php?action=post" method="post">
			...
			<input type="hidden" name="post_type" id="post_type" value="text" />
					...
					<?php
					submit_button ( __ ( 'Save Draft' ), 'button', 'draft', false, array (
							'id' => 'save' 
					) );
...
if (current_theme_supports ( 'post-formats' ) && post_type_supports ( 'post', 'post-formats' )) :
							...
							<div class="inside">
								<div class="tagsdiv" id="post_tag">
									<div class="jaxtag">
										...
										<input type="hidden" name="tax_input[post_tag]"
		...
		<div id="titlediv">
					...
					<div id="waiting" style="display: none">
						<span class="spinner"></span> <span><?php esc_html_e( 'Loading&hellip;' ); ?></span>
					</div>
		...
		function press_this_media_buttons() {
			...
			if (current_user_can ( 'upload_files' )) {
				?>
				<a id="photo_button" title="<?php esc_attr_e('Insert an Image'); ?>"
							href="#"> <img alt="<?php esc_attr_e('Insert an Image'); ?>"
