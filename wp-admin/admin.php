...
if (get_option ( 'db_upgraded' )) {
	 ...
	 *       
	 * @param
	 *        	bool true Whether to perform the Multisite upgrade routine. Default true.
	 */
...
if (current_user_can ( 'manage_options' )) {
	 ...
	 *       
	 * @param
	 *        	string 'WP_MAX_MEMORY_LIMIT' The maximum WordPress memory limit. Default 256M.
	 */
...
if (isset ( $plugin_page )) {
	 ...
	 *       
	 * @param
	 *        	bool false Whether to force data to be filtered through kses. Default false.
	 */
