...
<form id="setup" method="post" action="install.php?step=2"
	...
	?>
		...
		<?php if ( ! $user_table ) : ?>
		<tr>
				<th scope="row"><label for="pass1"><?php _e('Password, twice'); ?></label>
		...
		<tr>
			...
			<tr>
				...
				<td colspan="2"><label><input type="checkbox" name="blog_public"
						id="blog_public" value="1" <?php checked( $blog_public ); ?> /> <?php _e( 'Allow search engines to index this site.' ); ?></label></td>
			</tr>
		</table>
		<p class="step">
...
<h1><?php _e( 'Success!' ); ?></h1>
	...
	<p class="step">
		<a href="../wp-login.php" class="button button-large"><?php _e( 'Log In' ); ?></a>
	</p>
