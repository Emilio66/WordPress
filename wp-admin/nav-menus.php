...
get_current_screen ()->set_help_sidebar ( '<p><strong>' . __ ( 'For more information:' ) . '</strong></p>' . '<p>' . __ ( '<a href="http://codex.wordpress.org/Appearance_Menus_Screen" target="_blank">Documentation on Menus</a>' ) . '</p>' . '<p>' . __ ( '<a href="https://wordpress.org/support/" target="_blank">Support Forums</a>' ) . '</p>' );
	...
	<div class="manage-menus">
		...
		<?php else : ?>
			...
			<select name="menu" id="menu">
				...
				class="button-secondary" value="<?php esc_attr_e( 'Select' ); ?>"></span>
