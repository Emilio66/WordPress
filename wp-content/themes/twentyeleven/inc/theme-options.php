...
function twentyeleven_admin_enqueue_scripts($hook_suffix) {
	...
	wp_enqueue_script ( 'twentyeleven-theme-options', get_template_directory_uri () . '/inc/theme-options.js', array (
			'farbtastic' 
	), '2011-06-10' );
...
function twentyeleven_theme_options_init() {
	register_setting ( 'twentyeleven_options', // Options group, see settings_fields() call in twentyeleven_theme_options_render_page()
...
;
	...
	add_settings_section ( 'general', // Unique identifier for the settings section
...
;
	...
	add_settings_field ( 'color_scheme', // Unique identifier for the field for this section
...
function twentyeleven_theme_options_add_page() {
	$theme_page = add_theme_page ( __ ( 'Theme Options', 'twentyeleven' ), // Name of page
...
function twentyeleven_color_schemes() {
	 ...
	 * @since Twenty Eleven 1.0
	 *       
	 * @param array $color_scheme_options
...
<input type="button" class="pickcolor button hide-if-no-js"
...
function twentyeleven_theme_options_validate($input) {
	 ...
	 *       
	 * @param array $output
	 *        	An array of sanitized form output.
	 * @param array $input
	 *        	An array of un-sanitized form input.
...
function twentyeleven_customize_preview_js() {
	wp_enqueue_script ( 'twentyeleven-customizer', get_template_directory_uri () . '/inc/theme-customizer.js', array (
			'customize-preview' 
	), '20120523', true );
}
