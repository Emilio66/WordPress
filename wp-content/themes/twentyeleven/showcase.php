...
wp_enqueue_script ( 'twentyeleven-showcase', get_template_directory_uri () . '/js/showcase.js', array (
		'jquery' 
), '2011-04-28' );
...
<div id="primary" class="showcase">
	<div id="content" role="main">
			...
			<h1 class="showcase-heading"><?php _e( 'Featured Post', 'twentyeleven' ); ?></h1>
				...
				id="featured-post-<?php echo $counter_slider; ?>">
					...
					title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'twentyeleven' ), the_title_attribute( 'echo=0' ) ) ); ?>"
					...
					<?php
							...
							while ( $featured->have_posts () ) :
								...
								if (1 == $counter_slider)
									...
									$class = '';
								?>
						<li><a href="#featured-post-<?php echo $counter_slider; ?>"
						title="<?php echo esc_attr( sprintf( __( 'Featuring: %s', 'twentyeleven' ), the_title_attribute( 'echo=0' ) ) ); ?>"
						<?php echo $class; ?>></a></li>
					<?php endwhile;	?>
					</ul>
			</nav>
		...
		<!-- .featured-posts -->
			...
			<h1 class="showcase-heading"><?php _e( 'Recent Posts', 'twentyeleven' ); ?></h1>
					...
					while ( $recent->have_posts () ) :
						...
						<li class="entry-title"><a href="<?php the_permalink(); ?>"
				rel="bookmark"><?php the_title(); ?></a> <span class="comments-link">
