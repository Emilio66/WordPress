...
$wl_theme_options = weblizar_get_options ();
        ...
        <div class="item active">
          ...
          <img
				src="<?php echo esc_url($wl_theme_options['slide_image_1']); ?>"
				class="img-responsive"
				alt="<?php echo esc_attr($wl_theme_options['slide_title_1']); ?>">
          <?php } else { ?>
		  <img src="<?php echo esc_url($ImageUrl1); ?>" class="img-responsive"
				alt="First slide">
		  <?php } ?>		  
		  <div class="container">
            ...
            <a class="enigma_blog_read_btn animated bounceInUp"
							href="<?php if($wl_theme_options['slide_btn_link_1']!='') { echo esc_url($wl_theme_options['slide_btn_link_1']); } ?>"
		...
		<div class="item">		
          ...
          <img
				src="<?php echo esc_url($wl_theme_options['slide_image_2']); ?>"
				class="img-responsive"
				alt="<?php echo esc_attr($wl_theme_options['slide_title_2']); ?>">
          <?php } else { ?>
		  <img src="<?php echo esc_url($ImageUrl2); ?>" class="img-responsive"
				alt="Second slide">
		  <?php } ?>
          <div class="container">
				<div class="carousel-caption">			
			...
			<?php
			 ...
			 <?php
				...
				if ($wl_theme_options ['slide_btn_text_2'] != '') {
					?>
             <a class="enigma_blog_read_btn animated bounceInUp"
							href="<?php if($wl_theme_options['slide_btn_link_2']!='') { echo esc_attr($wl_theme_options['slide_btn_link_2']); } ?>"
		...
		<div class="item">		
          ...
          <img
				src="<?php echo esc_url($wl_theme_options['slide_image_3']); ?>"
				class="img-responsive"
				alt="<?php echo esc_attr($wl_theme_options['slide_title_3']); ?>">
          <?php } else { ?>
		  <img src="<?php echo esc_url($ImageUrl3); ?>" class="img-responsive"
				alt="Third slide">
		  <?php } ?>
          <div class="container">
				<div class="carousel-caption">
			...
			<?php
			 ...
			 <?php
				...
				if ($wl_theme_options ['slide_btn_text_3'] != '') {
					?>
            <a class="enigma_blog_read_btn animated bounceInUp"
							href="<?php if($wl_theme_options['slide_btn_link_3']!='') { echo esc_url($wl_theme_options['slide_btn_link_3']); } ?>"
