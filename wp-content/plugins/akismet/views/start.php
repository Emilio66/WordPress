	...
	<div class="activate-highlight activate-option">
		...
		<form name="akismet_activate" id="akismet_activate"
			...
			<input type="hidden" name="auto-connect"
				value="<?php echo $akismet_user->ID;?>" /> <input type="hidden"
				name="redirect" value="plugin-signup" /> <input type="submit"
	...
	<div class="activate-highlight activate-option">
		...
		<form name="akismet_activate" id="akismet_activate"
			...
			<input type="hidden" name="user_id"
				value="<?php echo $akismet_user->ID;?>" /> <input type="hidden"
				name="redirect" value="upgrade" /> <input type="submit"
				class="button button-primary"
...
<div class="activate-highlight secondary activate-option">
	...
	<div class="activate-highlight secondary activate-option">
		...
		<form action="<?php echo esc_url( Akismet_Admin::get_page_url() ); ?>"
			...
			<input id="key" name="key" type="text" size="15" maxlength="12"
				value="" class="regular-text code"> <input type="hidden"
